...
DISTRIBUTED BY HASH(app_id, device_md5) BUCKETS 32
PROPERTIES (
    "replication_num" = "3",
...
DISTRIBUTED BY HASH(app_id, cuid) BUCKETS 32
PROPERTIES (
    "replication_num" = "3",
    "enable_unique_key_merge_on_write" = "true"
);
...
DISTRIBUTED BY HASH(app_id, zg_device_id) BUCKETS 32
PROPERTIES (
    "replication_num" = "3",
    "enable_unique_key_merge_on_write" = "true"
);
...
DISTRIBUTED BY HASH(app_id, zg_user_id) BUCKETS 32
PROPERTIES (
    "replication_num" = "3",
    "enable_unique_key_merge_on_write" = "true"
);
...
DISTRIBUTED BY HASH(app_id, zg_id) BUCKETS 32
PROPERTIES (
    "replication_num" = "3",
    "enable_unique_key_merge_on_write" = "true"
);

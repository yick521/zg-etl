...
public class DataRouterOperator extends RichAsyncFunction<ZGMessage, RouterOutput> {
    ...
    private Map<String, String> extractUaResult(Map<String, Object> msgData) {
        ...
        LOG.debug("DEBUG extractUaResult: msgData.keys={}", msgData.keySet());
        LOG.debug("DEBUG extractUaResult: os={}, os_version={}, browser={}, browser_version={}",
                msgData.get("os"), msgData.get("os_version"),
                msgData.get("browser"), msgData.get("browser_version"));
        LOG.debug("DEBUG extractUaResult: result={}", result);
        return result;
    }

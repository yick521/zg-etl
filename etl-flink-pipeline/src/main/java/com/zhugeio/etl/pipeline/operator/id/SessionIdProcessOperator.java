...
public class SessionIdProcessOperator extends ProcessFunction<ZGMessage, ZGMessage> {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(SessionIdProcessOperator.class);
    ...
    private ZGMessage createOutput(ZGMessage input) {
        Map<String, Object> dataMap = input.getData();
        ...
        LOG.debug("SessionIdProcessOperator innerData : {} , type is {}",innerData, innerData.getClass().getName());

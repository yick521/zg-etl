...
public final class CacheKeyConstants {
     ...
     */
    public static final String EVENT_LAST_UPDATE_TIME_MAP = "eventLastUpdateTimeMap";
     ...
     * Value: ${currentTime}
     */
    public static final String EVENT_CURRENT_PROCESS_TIME_MAP = "eventCurrentProcessTimeMap";
     ...
     * 禁止创建事件的应用 ID 集合
     * Member: ${appId}
     * 把应用当前事件数量和允许最大数量对比，如果超出限制则加入此集合
     */
     ...
     * 构建事件属性平台 Set Member
     */
    public static String attrIdPlatformMember(Integer attrId, Integer platform) {
    ...
    /**
     * App SDK 有数据标记的 Field（别名，与上面相同）
     * 用于 SetAppIdAndBusinessOperator
     */
    public static String appSdkHasDataField(Integer appId, Integer platform) {
        return sdkHasDataField(appId, platform);
    }
}
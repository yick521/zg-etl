...
public class Config {
    ...
    public static final String FILTER_AKS = "filter.aks";
    ...
    public static final String DORIS_SINK_BATCH_MAX_ROWS = "doris.sink.batch.max-rows";
    public static final String DORIS_SINK_BATCH_MAX_BYTES = "doris.sink.batch.max-bytes";
    public static final String DORIS_SINK_BATCH_FLUSH_INTERVAL = "doris.sink.batch.flush-interval";


    public static final String DORIS_SINK_PARALLELISM_EVENT_ATTR = "doris.sink.event-attr.parallelism";
    public static final String DORIS_SINK_PARALLELISM_USER = "doris.sink.user.parallelism";
    public static final String DORIS_SINK_PARALLELISM_DEVICE = "doris.sink.device.parallelism";
    public static final String DORIS_SINK_PARALLELISM_USER_PROP = "doris.sink.user-prop.parallelism";

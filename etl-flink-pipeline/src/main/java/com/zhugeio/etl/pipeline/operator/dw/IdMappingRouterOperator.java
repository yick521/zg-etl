...
import com.zhugeio.etl.pipeline.entity.IdMappingMessage.MappingType;
 ...
 */
public class IdMappingRouterOperator extends ProcessFunction<IdMappingMessage, DeviceIdRow> {

    private static final long serialVersionUID = 1L;
    private static final Logger LOG = LoggerFactory.getLogger(IdMappingRouterOperator.class);
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        LOG.info("[IdMappingRouter-{}] 初始化完成", 
                getRuntimeContext().getIndexOfThisSubtask());
    }

    @Override
    public void processElement(IdMappingMessage msg, Context ctx, 
        ...
        MappingType type = msg.getMappingType();
        if (type == null) {
            errorCount.incrementAndGet();
    ...
    public void close() throws Exception {
        LOG.info("[IdMappingRouter] 统计: DEVICE={}, USER={}, DEVICE_ZGID={}, " +

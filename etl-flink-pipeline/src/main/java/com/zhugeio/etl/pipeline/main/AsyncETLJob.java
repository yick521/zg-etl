...
public class AsyncETLJob {
    ...
    public static void main(String[] args) {
        ...
        // id : x. 主流继续处理-处理广告  投放四期：app端广告信息存ssdb ip+ua
        ...
        // id : x. 主流继续处理-处理广告  投放五期：新增 事件属性（lid）、用户属性(首次、末次)
        ...
        // id : x. 主流继续处理-处理广告  投放五期：查询回传表判断是否符合回传行为 (匹配深度回传事件并发kafka)
        SingleOutputStreamOperator<ZGMessage> convertEventDataStream;
        if("true".equals(advBussStart)){
            convertEventDataStream = advSaveAppAdDataStream;

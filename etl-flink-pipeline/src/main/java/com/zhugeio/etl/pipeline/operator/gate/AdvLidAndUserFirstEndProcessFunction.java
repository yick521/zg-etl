 ...
 * @description 分流
 */
public class AdvLidAndUserFirstEndProcessFunction extends ProcessFunction<ZGMessage, ZGMessage> {
    private OutputTag<String> advSaveAppAdDataTag;

    public AdvLidAndUserFirstEndProcessFunction() {
    }

    public AdvLidAndUserFirstEndProcessFunction(OutputTag<String> advSaveAppAdDataTag) {

...
public class IdJob {
     ...
     * @return 处理后的数据流
     */
    public static DataStream<ZGMessage> execute(DataStream<ZGMessage> source) {
        // 1. 构建流水线
    ...
    public static SingleOutputStreamOperator<ZGMessage> buildIdPipeline(DataStream<ZGMessage> source) {
        // 从 Config 获取配置
        int asyncCapacity = Config.getInt("async.capacity", 100);
        ...
        SingleOutputStreamOperator<ZGMessage> idStep2 = AsyncDataStream.unorderedWait(
                idStep1,
                new SetAppIdAndBusinessOperator(kvrocksHost, kvrocksPort, kvrocksCluster),
                asyncTimeoutMs, TimeUnit.MILLISECONDS, asyncCapacity
        ...
        SingleOutputStreamOperator<ZGMessage> idStep5 = AsyncDataStream.unorderedWait(
                idStep4,
                new DevicePropertyOperator(kvrocksHost, kvrocksPort, kvrocksCluster),
                asyncTimeoutMs, TimeUnit.MILLISECONDS, asyncCapacity
        ...
        SingleOutputStreamOperator<ZGMessage> idStep6 = AsyncDataStream.unorderedWait(
                idStep5,
                new VirtualPropertyOperator(kvrocksHost, kvrocksPort, kvrocksCluster),
                asyncTimeoutMs, TimeUnit.MILLISECONDS, asyncCapacity
        ...
        SingleOutputStreamOperator<ZGMessage> idStep7 = AsyncDataStream.unorderedWait(
                idStep6,
                new VirtualEventOperator(kvrocksHost, kvrocksPort, kvrocksCluster),
                asyncTimeoutMs, TimeUnit.MILLISECONDS, asyncCapacity
        ...
        SingleOutputStreamOperator<ZGMessage> idStep8 = AsyncDataStream.unorderedWait(
                idStep7,
                new EventAsyncOperator(kvrocksHost, kvrocksPort, kvrocksCluster, Config.getRdbmsProperties(), maxPropLength),
                asyncTimeoutMs, TimeUnit.MILLISECONDS, asyncCapacity
        ...
        SingleOutputStreamOperator<ZGMessage> idStep9 = AsyncDataStream.unorderedWait(
                idStep8,
                new EventAttrAsyncOperator(kvrocksHost, kvrocksPort, kvrocksCluster, maxPropLength),
                asyncTimeoutMs, TimeUnit.MILLISECONDS, asyncCapacity
        ...
        SingleOutputStreamOperator<ZGMessage> idStep10 = AsyncDataStream.unorderedWait(
                idStep9,
                new UserPropAsyncOperator(kvrocksHost, kvrocksPort, kvrocksCluster, Config.getRdbmsProperties(), maxPropLength),
                asyncTimeoutMs, TimeUnit.MILLISECONDS, asyncCapacity
    ...
    public static void addSinks(SingleOutputStreamOperator<ZGMessage> result) {
        ...
        boolean sinkToDownstream = Config.getBoolean(Config.ID_SINK_TO_DOONSTREAM, true);
        ...
        // 数据质量侧输出
        SideOutputDataStream<String> dqSideOutput = result.getSideOutput(DATA_QUALITY_TAG);
        CustomKafkaSink.addCustomKafkaSink(
                dqSideOutput,
        ...
        LOG.info("ID Sink 配置完成, sinkToDownstream={}", sinkToDownstream);
    }
